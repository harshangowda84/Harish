...
INSERT INTO "new_PassengerRegistration" ("address", "age", "createdAt", "declineReason", "documents", "email", "id", "idNumber", "idType", "passName", "passType", "passValidity", "passengerName", "phoneNumber", "photoPath", "photoVerified", "rfidUid", "status", "uniquePassId", "updatedAt", "userId") SELECT "address", "age", "createdAt", "declineReason", "documents", "email", "id", "idNumber", "idType", "passName", "passType", "passValidity", "passengerName", "phoneNumber", "photoPath", "photoVerified", "rfidUid", "status", "uniquePassId", "updatedAt", "userId" FROM "PassengerRegistration";
...
INSERT INTO "new_StudentRegistration" ("collegeId", "course", "createdAt", "id", "passValidity", "photoPath", "photoVerified", "rfidUid", "status", "studentId", "studentName", "uniquePassId") SELECT "collegeId", "course", "createdAt", "id", "passValidity", "photoPath", "photoVerified", "rfidUid", "status", "studentId", "studentName", "uniquePassId" FROM "StudentRegistration";
